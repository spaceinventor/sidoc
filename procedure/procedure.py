...
class Procedure:
    ...
    def send_google_chat_notification(self, message):
        ...
        """
        webhook_url = "https://chat.googleapis.com/v1/spaces/AAAA-Awd0WI/messages?key=AIzaSyDdI0hCZtE6vySjMm-WEfRq3CPzqKqqsHI&token=HYmcaHuNdKBgflngxyBx0d0uo-1vc2RZDUC5uatHaAs"  # Replace with your actual webhook URL
